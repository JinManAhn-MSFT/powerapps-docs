...
This category analyzes the state of page loads. Warm page load renders the page with leveraging caches and existing DOM objects, while cold page load renders the page fresh with downloading resources if required.
